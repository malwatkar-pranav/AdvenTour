...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $update_query = "UPDATE users SET UserName='$username', question1 = '$collegename', question2 = '$mothername' WHERE ID = $user_id";
...
<body>
    <button style="float:left;max-width:100px" onclick="window.location.href='userdetails.php'">Back</button>
    <h2>Edit User Information</h2>

    <form method="post" action="">
        <label for="UserName">User Name:</label>
        <input type="text" name="name" value="<?php echo $user['UserName']; ?>" required><br>
